...
SECRET_KEY = 'n765d-per2u*o+9)ya0v3sdn#y%m2_knppy*^3zls8!l*9-vcb'
...
INSTALLED_APPS = [
    ...
    'drf_yasg',  # For Swagger/OpenAPI 2.0 Documentation
    'corsheaders',  # For allowing all Cross-Origin Resource Sharing (CORS)
    'rest_framework',  # Django REST framework for implementing REST APIs
    'django_filters',  # Filter Query set
...
REST_FRAMEWORK = {
    ...
    # https://www.django-rest-framework.org/api-guide/settings/#default_schema_class
